 ...
 * @endcode
 */
$settings['hash_salt'] = 'FbxxV3zvEYOCQuP9_m0gwWzw-LjRZmCOFhSBEk8uYHsDDg1rrB0h9r8ZaCLWS8MXu7QUAJZGmw';
...
$settings['config_sync_directory'] = 'sites/default/files/config_sanskriti/sync';
$env = 'local';
switch($env) {
    case 'local':
